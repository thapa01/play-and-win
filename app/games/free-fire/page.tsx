        ...
        <div className="mx-auto max-w-7xl px-5 py-12 sm:px-6 sm:py-16">
          ...
          <div className="mt-10">
            ...
            <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-500 sm:text-base">
              Join Free Fire tournaments, compete against skilled players and
        ...
        <div className="mx-auto max-w-7xl px-5 sm:px-6">
          ...
          {error ? (
            <div className="rounded-2xl border border-red-200 bg-red-50 p-6 text-sm font-semibold text-red-600">
              Unable to load Free Fire tournaments right now.
            </div>
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-10 text-center shadow-sm">
              ...
              <p className="mt-2 text-sm text-slate-500">
                New Free Fire tournaments will appear here when they are
                created.
              </p>
