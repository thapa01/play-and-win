        ...
        <div className="mx-auto max-w-7xl px-5 py-16 sm:px-6">
          ...
          <div className="mt-10">
            ...
            <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-500 sm:text-base">
              Join PUBG tournaments, compete against skilled players and
        ...
        <div className="mx-auto max-w-7xl px-5 sm:px-6">
          ...
          {error ? (
            <div className="rounded-2xl border border-red-200 bg-red-50 p-6 text-sm font-semibold text-red-600">
              Unable to load PUBG tournaments right now.
            </div>
          ) : !tournaments || tournaments.length === 0 ? (
            <div className="rounded-3xl border border-slate-200 bg-white p-10 text-center shadow-sm">
              <h3 className="text-xl font-black text-slate-950">
                No PUBG tournaments available
              </h3>

              <p className="mt-2 text-sm text-slate-500">
                New PUBG tournaments will appear here when they are created.
              </p>
